describe("FizzBuzz", function(){
    ...
    it("should say Fizz when put 9", function(){
        var fizzbuzz = new FizzBuzz(9);
        expect(fizzbuzz.say()).toEqual("Fizz");
    });

    it("should say Buzz when put 10", function(){
        var fizzbuzz = new FizzBuzz(10);
        expect(fizzbuzz.say()).toEqual("Buzz");
    });

    it("should say Fizz when put 12", function(){
        var fizzbuzz = new FizzBuzz(12);
        expect(fizzbuzz.say()).toEqual("Fizz");
    });

    it("should say FizzBuzz when put 15", function(){
        var fizzbuzz = new FizzBuzz(15);
        expect(fizzbuzz.say()).toEqual("FizzBuzz");
    });

    it("should say Buzz when put 20", function(){
        var fizzbuzz = new FizzBuzz(20);
        expect(fizzbuzz.say()).toEqual("Buzz");
    });

    it("should say FizzBuzz when put 30", function(){
        var fizzbuzz = new FizzBuzz(30);
        expect(fizzbuzz.say()).toEqual("FizzBuzz");
    });

    it("should say FizzBuzz when put 45", function(){
